...
class UIFunc(QMainWindow, Ui_UIView, QtStyleTools):
    def __init__(self, app):
        ...
        self.label_launch_or_pause = Label('F6')
        self.label_launch_or_pause.setAlignment(Qt.AlignCenter)
        self.horizontal_launch_or_pause.addWidget(self.label_launch_or_pause)
        
        self.label_record_or_pause = Label('F10')
        self.label_record_or_pause.setAlignment(Qt.AlignCenter)
        self.horizontal_record_or_pause.addWidget(self.label_record_or_pause)

        self.label_stop = Label('F9')
        self.label_stop.setAlignment(Qt.AlignCenter)
        self.horizontal_stop.addWidget(self.label_stop)
        ...
        def hotkeymethod(key_name):
            ...
            launch_or_pause_name = self.label_launch_or_pause.text().lower()
            record_or_pause_name = self.label_record_or_pause.text().lower()
            stop_name = self.label_stop.text().lower()

            if key_name == launch_or_pause_name and not self.running and not self.recording:
            ...
            elif key_name == launch_or_pause_name and self.running and not self.recording:
                if self.paused:
            ...
            elif key_name == record_or_pause_name and not self.running:
            ...
            return key_name in [launch_or_pause_name, stop_name, record_or_pause_name]
