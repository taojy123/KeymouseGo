...
```
[
 [3000, "EM", "mouse right down", [0.052083333333333336, 0.18518518518518517]],    // 开始运行 `3000ms` 后，在屏幕坐标 `(100,200)` 处 `按下鼠标右键`；
 ...
 [100,  "EM", "mouse left down",  [0.2604166666666667, 0.46296296296296297]],    // 等待 `100ms` 后，在屏幕坐标 `(500, 500)` 处 `按下鼠标左键`；
 [100,  "EM", "mouse move",       [0.2604166666666667, 0.5555555555555556]],    // 等待 `100ms` 后，鼠标移动至 `(500, 600)` 位置；
 [100,  "EM", "mouse left down",  [0.3125, 0.5555555555555556]],    // 等待 `100ms` 后，在屏幕坐标 `(600, 600)` 处 `抬起鼠标左键`；
